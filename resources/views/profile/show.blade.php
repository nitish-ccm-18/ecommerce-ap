            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        <img src="{{ $profile[0]->profile->avatar ? url('public/Image/Users/' . $profile[0]->profile->avatar) : 'https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp' }}" alt="avatar"
                ...
                <div class="card card-body">
                    <form class="form-horizontal" method="post" action="/profile/update" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" type="text" name="phone" value="{{$profile[0]->profile->phone}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">Occupation</label>
                            <div class="col-lg-8">
                                <input class="form-control" type="text" value="{{$profile[0]->profile->occupation}}" name="occupation">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Address</label>
                            <div class="col-md-8">
                                <input class="form-control" type="address" value="{{$profile[0]->profile->address}}" name="address">
                            </div>
                        </div>
                        <div class="form-group">
